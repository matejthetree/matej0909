...
export default function Offerings() {
  ...
  const offerings = [
    {
      id: 'tobacco',
      titleKey: 'offerings.tobacco.title',
      subtitleKey: 'offerings.tobacco.subtitle',
      descriptionKey: 'offerings.tobacco.description',
      detailsKey: 'offerings.tobacco.details',
      icon: <TobaccoLeafIcon className="w-full h-full text-amber-700 opacity-60" />,
      cornerIcon: TobaccoLeafIcon,
    },
    {
      id: 'ceremonies',
      titleKey: 'offerings.ceremonies.title',
      subtitleKey: 'offerings.ceremonies.subtitle',
      descriptionKey: 'offerings.ceremonies.description',
      detailsKey: 'offerings.ceremonies.details',
      icon: <CeremonialVesselIcon className="w-full h-full text-emerald-700 opacity-60" />,
      cornerIcon: CeremonialVesselIcon,
    },
    {
      id: 'dieta',
      titleKey: 'offerings.dieta.title',
      subtitleKey: 'offerings.dieta.subtitle',
      descriptionKey: 'offerings.dieta.description',
      detailsKey: 'offerings.dieta.details',
      icon: <BirchBranchIcon className="w-full h-full text-stone-600 opacity-60" />,
      cornerIcon: BirchBranchIcon,
    },
    {
      id: 'talks',
      titleKey: 'offerings.talks.title',
      subtitleKey: 'offerings.talks.subtitle',
      descriptionKey: 'offerings.talks.description',
      detailsKey: 'offerings.talks.details',
      icon: (
      ...
      <div className="relative z-10 min-h-screen noise-overlay">
        ...
        <section className="min-h-[60vh] flex items-center justify-center px-6 pt-24">
          ...
          >
            ...
            >
              <span className="text-xs tracking-[0.4em] uppercase text-[#c9a227]/60">{t('offerings.label')}</span>
            </motion.div>
        ...
        <section className="px-6 py-20">
          ...
          >
            {offerings.map((offering, index) => {
              const details = t(offering.detailsKey, { returnObjects: true }) as string[];
              return (
                <motion.div
                  key={offering.id}
        ...
        <section className="px-6 py-16">
          <div className="max-w-4xl mx-auto text-center">
            <h3 className="text-2xl text-[#f5f0e6]/40 font-light mb-8">{t('offerings.stayInLoop')}</h3>
            <Newsletter
              title={t('newsletter.joinCircle')}
              description={t('newsletter.stayConnectedDescription')}
            />
          </div>
        </section>
